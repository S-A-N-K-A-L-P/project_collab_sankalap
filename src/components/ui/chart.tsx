...
>(
  (
    ...
    const tooltipPayload = (props as any).payload;
    ...
    return (
      ...
      >
        ...
        <div className="grid gap-1.5">
          {(tooltipPayload as any[]).map((item, index) => {
...
>(({ className, hideIcon = false, verticalAlign = "bottom", nameKey, ...rest }, ref) => {
  const { config } = useChart();
  const legendPayload = (rest as any).payload;

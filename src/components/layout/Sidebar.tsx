              ...
              {group.items.map((item) => {
                ...
                return (
                  <Link
                    key={item.name}
                    href={href}
                    className={`flex items-center gap-3 px-3 py-2 rounded-md text-[13px] font-medium transition-all group relative ${
                      isActive 
                  ...
                  >
                    ...
                    <item.icon className={`w-4 h-4 transition-colors ${
                      isActive ? "text-[#6366f1]" : "text-[#9ca3af] group-hover:text-[#e5e7eb]"
                    }`} />
                    {item.name}
                  </Link>
                );
